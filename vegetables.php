							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									...
									<a href="#"><img src="images/o3jpg.jpg" alt=" " class="img-responsive" height="140px"  width="140px"/></a>
											<p>oinion (1 kg)</p>
											<h4>Rs. 40.00 </i><span>Rs.<del> 45.00</del> </i></h4>
										</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rs. 60.00 </i><span>Rs.<del> 80.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rs. 20.00 </i><span>Rs.<del> 30.00</del> </i></span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rs. 10.00 </i><span>Rs.<del> 15.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>poteto(1kg)</p>
											<h4>Rs. 30.00 </i><span>Rs.<del> 40.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>bhindi (1 kg)</p>
											<h4Rs. 30.00 </i><span>Rs.<del> 40.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>Tamatar(1 kg)</p>
											<h4>Rs. 80.00 </i><span>Rs.<del> 100.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p> Cabbage(1 kg)</p>
											<h4>Rs. 50.00 </i><span>Rs.<del> 60.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p> Peas(1 kg)</p>
											<h4>Rs. 60.00 </i><span>Rs.<del> 70.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
					...
					<div class="col-md-3 w3ls_w3l_banner_left w3ls_w3l_banner_left_asd">
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<a href="single.php"><img src="images/spring.jpg" alt=" " class="img-responsive" height="140px"  width="140px"/></a>
											...
											<h4Rs. 20.00 </i><span>Rs.<del> 30.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4>Rs. 20.00 </i><span>Rs.<del> 30.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
